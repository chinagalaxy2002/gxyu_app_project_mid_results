...
public class LiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 加载模型
        try {
            mModule = LiteModuleLoader.load(DetectResultActivity.assetFilePath(getApplicationContext(), "mask.torchscript.ptl"));
            BufferedReader br = new BufferedReader(new InputStreamReader(getAssets().open("mask_classes.txt")));
            String line;
